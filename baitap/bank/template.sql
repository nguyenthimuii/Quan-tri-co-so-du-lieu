...
insert into customer values('000002',N'Trần Đức Quý','01638843209',N'215/90 VÕ VĂN KIỆT, PHƯỜNG THANH XU N, TP BUÔN MA THUỘT, ĐĂK LĂK','VT010');
...
insert into customer values('000007',N'Trần Trương Thiện Nguyên','01265323711',N'TỔ D N PHỐ 4,P NAM LÝ, TP ĐỒNG HỚI, QUẢNG BÌNH','VB001');
insert into customer values('000008',N'Nguyễn Lê Minh Quân','0962883220',N'K79/4 THANH THỦY, HẢI CH U, ĐÀ NẴNG','VB002');
...
insert into customer values('000015',N'Trương Quang Hòa','0976308098',N'294 HUỲNH THÚC KHÁNG, AN XU N, TAM KỲ, QUẢNG NAM','VT009');
insert into customer values('000016',N'Lê Anh Huy','0966654330',N'412 CÁCH MẠNG THÁNG 8, QUẬN CẨM LỆ, ĐÀ NẴNG','VT010');
insert into customer values('000017',N'Hồ Trần Nhật Khánh','01648438000',N'193/12 NÚI THÀNH, PHƯỜNG HÒA CƯỜNG BẮC, HẢI CH U, ĐÀ NẴNG','VT011');
...
insert into customer values('000035',N'Trương Duy Tường','01645500071',N'ĐỘI 1 - PHAN XÁ - XU N THỦY - LỆ THỦY - QuẢNG BÌNH','VT011');
...
insert into transactions values('0000000406','1',43527000,'2013-03-14','11:22','1000000012');